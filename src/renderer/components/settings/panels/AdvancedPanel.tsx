...
import { SettingRow, SettingGroup, SettingToggle, SettingSelect, SettingInput } from '../components'
      ...
      <SettingGroup title={t('panels.advanced.developer.title')}>
        ...
        >
          <SettingSelect
            ...
            onChange={(value) => updateAdvanced({ logLevel: value as 'debug' | 'info' | 'warn' | 'error' })}
            options={[
        ...
        <div className="rounded-lg border border-destructive/50 bg-destructive/5 p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-3 flex-1">
              <div>
                <h4 className="text-sm font-medium text-destructive">{t('panels.advanced.dangerZone.resetAllSettings')}</h4>
